...
--
-- Modifications --------------------------------------------------------------
--   The original script has been modified to receive SRSNO and SRSNAME as parameter
--   using the psql "-v" switch instead of prompting for user input.
--
...
-- \echo 'SRSNO       ' :'SRSNO'
-- \echo 'SRS_NO      ' :SRS_NO
-- \echo 'srsname     ' :srsname
-- \echo 'GMLSRSNAME  ' :GMLSRSNAME
